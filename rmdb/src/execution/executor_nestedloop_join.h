...
class NestedLoopJoinExecutor : public AbstractExecutor {
   ...
   public:
    ...
    std::unique_ptr<RmRecord> Next() override {
        ...
        auto left_next = left_->Next();
        auto right_next = right_->Next();
        // memecpy()可能对你有所帮助
        memcpy(record->data, left_next->data, left_next->size);
        memcpy(record->data + left_next->size, right_next->data, right_next->size);
